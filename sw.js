const VERSION='studymate-v23';
const APP_CACHE=`${VERSION}-app`;
const DATA_CACHE=`${VERSION}-data`;
const APP_SHELL=['./','./index.html','./app-manifest.txt?v=23','./assets/studymate-logo.webp?v=23','./js/css-loader.js?v=22','./js/app-loader.js?v=22','./js/config.js?v=22','./js/youtube-simple.js?v=22','./js/install-guide.js?v=23'];
