  ...
  shadow.innerHTML=`
    <style>
      ...
      *{box-sizing:border-box}
      ...
      .head{display:grid;grid-template-columns:58px 1fr;gap:12px;align-items:center;padding-left:38px;margin-bottom:14px}
      .logo-box{width:58px;height:58px;border-radius:16px;display:grid;place-items:center;overflow:hidden;background:#08152f;border:1px solid rgba(104,167,255,.2);box-shadow:0 8px 24px rgba(45,112,255,.15)}
      ...
      @media(max-width:380px){.backdrop{padding:8px}.sheet{width:100%;padding:15px;border-radius:20px}.head{grid-template-columns:50px 1fr}.logo-box{width:50px;height:50px}h2{font-size:16px}.step p{font-size:11px}}
    </style>
